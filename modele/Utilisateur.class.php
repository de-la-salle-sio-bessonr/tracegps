...
class Utilisateur
{
    ...
    public function __construct($unId, $unPseudo, $unMdpSha1, $uneAdrMail, $unNumTel, $unNiveau,
        $uneDateCreation, $unNbTraces, $uneDateDerniereTrace) {
            ...
            $this->dateDernireTrace =$uneDateDerniereTrace;
    ...
    public function getDateDerniereTrace() {return $this->dateDernireTrace;}
    public function setDateDerniereTrace($uneDateDerniereTrace) {$this->dateDernireTrace = $uneDateDerniereTrace;}
